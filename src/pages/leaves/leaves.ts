...
export class LeavesPage {
  ...
  constructor(public modalCtrl: ModalController, public helper: Heplers, public LevService: LeavesService, public navCtrl: NavController, public navParams: NavParams) {
    //this.GetLeaves();
  }
...
export class ModalContentPage {
  ...
  constructor(
    public platform: Platform, public helper: Heplers,
